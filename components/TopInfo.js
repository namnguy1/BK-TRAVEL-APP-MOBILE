...
import { ArchiveBoxXMarkIcon,UserIcon, ChevronRightIcon, ChevronDownIcon, HeartIcon, ShoppingCartIcon, Cog8ToothIcon, EnvelopeIcon,CloudIcon,StarIcon } from 'react-native-heroicons/outline'
...
export default function TopInfo() {
  ...
  return (
    <View className="p-10 space-y-6">
      ...
      <View className="p-2 w-full h-12 bg-white rounded-lg flex-row justify-between items-center">
        <View className="flex-row space-x-4 items-center">
          <ArchiveBoxXMarkIcon size="24" strokeWidth={1} color="black" />
          <Text className="text-gray-500 text-xl">Đơn hàng đã hủy</Text>
        </View>
        <TouchableOpacity onPress={()=>navigation.navigate('RefundTour')}>
          <ChevronRightIcon size="22" strokeWidth={2} color="black" />
        </TouchableOpacity>
      </View>
      <View className="p-2 w-full h-12 bg-white rounded-lg flex-row justify-between items-center">
        <View className="flex-row space-x-4 items-center">
          <StarIcon size="23" strokeWidth={1} color="black" />
          <Text className="text-gray-500 text-xl">Ưu đãi</Text>
        </View>
        <TouchableOpacity onPress={()=>navigation.navigate('EndowScreen')}>
          <ChevronRightIcon size="22" strokeWidth={2} color="black" />
        </TouchableOpacity>
      </View>
      <View className="p-2 w-full h-12 bg-white rounded-lg flex-row justify-between items-center">
